...
const SplitLayout = ({ children }: SplitLayoutProps) => {
  ...
  return (
    <div className="flex gap-10">
      <div
        className={clsx(
          "transition-all max-sm:hidden duration-700 border-white border-1 h-[50pc] mx-3 my-5 flex justify-center rounded-2xl bg-gradient-to-b from-purple-700 to-10%",
